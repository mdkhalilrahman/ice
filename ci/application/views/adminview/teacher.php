...
<div>
	<center><h1>ICE Teacher list</h1></center>
	<h4><?= anchor('teacher/teachers','Add_teacher',['class'=>'btn btn-primary']) ?></h4>
	<table class="table table-striped table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<?=
						form_open('teacher/teacherdelete'),
						form_hidden('id',$value->id),
