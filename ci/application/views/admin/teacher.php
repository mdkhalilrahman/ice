...
<center><h1 class="mt-5">ICE TEACHER</h1></center>	
<div id="fm" class="m-4">
	<div class="m-4">
	<?= form_open_multipart('teacher/teacherINsert') ?>
	<center><h1>teacher form</h1></center>
  		...
  		<div class="row">
	  		...
	  		<div class="col-lg-6">
	    		  ...
	    		  <div class="form-group">
		         <?= form_input(['class'=>'form-control','placeholder'=>'Enter university..','name'=>'university','required'=>'1','value'=>set_value('university')]); ?>
  		...
  		<div class="row">
	   		<div class="col-lg-6">
		        ...
		        <div class="form-group">
		         <?= form_input(['class'=>'form-control','placeholder'=>'Enter your designation..','name'=>'designation','required'=>'1','value'=>set_value('designation')]); ?>
	  		...
	  		<div class="col-lg-6">
	    		...
	    		<div class="form-group">
		         <?= form_input(['class'=>'form-control','placeholder'=>'Enter your qualification...','name'=>'qualification','required'=>'1','value'=>set_value('qualification')]); ?>
  		...
  		<div class="row">
	  		...
	  		<div class="col-lg-6">
	    		  ...
	    		  <div class="form-group">
		         <?= form_input(['class'=>'form-control','placeholder'=>'Enter your thisis...','name'=>'thisis','required'=>'1','value'=>set_value('thisis')]); ?>
		  		<?= form_error('thisis'); ?>
		  		</div>
	     	</div>
      	</div>
  		...
  		<div class="row">
	   		<div class="col-lg-6">
		        <div class="form-group">
		         ...
		         <?= form_input(['class'=>'form-control','placeholder'=>'Enter your phone...','name'=>'phone','required'=>'1','value'=>set_value('phone')]); ?>
		         <?= form_error('phone'); ?>
		  		</div>
	  		</div>
	  		<div class="col-lg-6">
