...
-->
	...
	<h1>MY name is khalil...</h1>
	<?= anchor('ice1st/ice1stUser', 'ice1st', ['class'=>'btn btn-primary']); ?>
	<?= anchor('ice2nd/ice2ndUser', 'ice2nd', ['class'=>'btn btn-primary']); ?>
	<?= anchor('ice3rd/ice3rdUser', 'ice3rd', ['class'=>'btn btn-primary']); ?>
	<?= anchor('ice4th/ice4thUser', 'ice4th', ['class'=>'btn btn-primary']); ?>
	<?= anchor('ice5th/ice5thUser', 'ice5th', ['class'=>'btn btn-primary']); ?>
	<?= anchor('ice6th/ice6thUser', 'ice6th', ['class'=>'btn btn-primary']); ?>
	<?= anchor('ice7th/ice7thUser', 'ice7th', ['class'=>'btn btn-primary']); ?>
	<?= anchor('teacher/teacherUser','teacher',['class'=>'btn btn-primary']); ?>
	<?= anchor('home/homeview','home',['class'=>'btn btn-primary']); ?>
